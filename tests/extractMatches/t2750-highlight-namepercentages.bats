...
@test "percentages for counts from one name, but not from another name" {
    run extractMatches --name-percentages fours --match-count fo+ --global --name foos --match-count '\<\w{4}\>' --global --name fours <<-'EOF'
Or some sexy text.
This text has foo, or foooo and foofoo in it.
All more simple text.
And more foo text here.
...
@test "percentages for counts from multiple names" {
    run extractMatches --name-percentages fours --name-percentages foos --match-count fo+ --global --name foos --match-count '\<\w{4}\>' --global --name fours <<-'EOF'
Or some sexy text.
This text has foo, or foooo and foofoo in it.
All more simple text.
And more foo text here.
...
@test "percentages for selected match-counts from multiple names" {
    run extractMatches --name-percentages fours-text --name-percentages foos-fooo --match-count fo+ --global --name foos --match-count '\<\w{4}\>' --global --name fours <<-'EOF'
Or some sexy text.
This text has foo, or foooo and foofoo in it.
All more simple text.
And more foo text here.
...
@test "percentages for count and match-counts are combined under same name prefix" {
    run extractMatches --name-percentages fo --count fo+ --global --name foos --name foos --match-count '\<\w{4}\>' --global --name fours <<-'EOF'
Or some sexy text.
This text has foo, or foooo and foofoo in it.
All more simple text.
...
@test "percentages for count and match-counts with reset are combined" {
    run extractMatches --name-percentages fo --count fo+ --global --name foos --reset-name '[Aa]nd' --name foos --match-count '\<\w{4}\>' --global --name fours --reset-name '[Oo]r' --name fours <<-'EOF'
Or some sexy text.
This text has foo, or foooo and foofoo in it.
All more simple text.
And more foooo text here.
